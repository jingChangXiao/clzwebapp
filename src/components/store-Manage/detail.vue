          ...
          <div>
            <div class="mui-card">
              <div class="mui-card-header mui-card-media"
                   style="height:40vw;background-image:url(./static/img/muwu.jpg)"></div>
              <div class="mui-card-content">
                <div class="mui-card-content-inner">
                  <div v-text="detail.data.name"></div>
                  <div>
                    <span>片区经理:<span></span></span>
                    <span style="float:right">门店代码: <span v-text="detail.data.storeCode"></span></span>
                  </div>
                </div>
              </div>
            </div>
            <div>
              <div class="mui-row">
                <div class="mui-col-sm-6 mui-col-xs-6" style="text-align: center" @tap="changeFlag(0)">
                  基本信息
                </div>
                <div class="mui-col-sm-6 mui-col-xs-6" style="text-align: center" @tap="changeFlag(1)">
                  更多信息
                </div>
              </div>
            </div>
            <div>
              ...
              <div v-show="showFlag === 1">
                ...
                <div class="list-base-information">
                  ...
                  <div class="list-item-right" v-text="detail.data.workTimeStart + ' - ' + detail.data.workTimeEnd"></div>
                </div>
              </div>
            </div>
          </div>
