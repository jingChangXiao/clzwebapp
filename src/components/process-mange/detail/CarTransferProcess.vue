...
<template>
  <div>
    <content-title :titleData="{title: '车辆调动'}"></content-title>
          ...
          <div class="detail-content">
            ...
            <div class="list-base-information-chunk">
              ...
              <div class="list-base-information">
                <div class="list-item-left">截止日期</div>
                <div class="list-item-right" v-text="formatFn(detail.info.closingDate)"></div>
              </div>
  ...
  export default{
    data () {
      return {
        ...
        tableItems: [
          ...
          {name: 'areaName', label: '片区'},
          {name: 'userName', label: '使用人'},
          {name: 'transferAreaName', label: '调入片区'},
          {name: 'leadpartyUserName', label: '领用人'},
          {name: 'parkingPointName', label: '调用停车'},
          {name: 'usePropertiesName', label: '使用性'},
          {name: 'remark', label: '备注'},
          {name: 'causeTransfer', label: '调动原因'}
        ]
      }
    },
    components: {
    ...
    methods: {
      ...
      getDetail () {
        ...
        let infoData = {url: APIS.processCenter.carTransfer, method: 'GET', param: infoParam}
