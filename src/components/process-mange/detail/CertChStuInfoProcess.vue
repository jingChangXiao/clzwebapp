      ...
      <div class="mui-scroll-wrapper _mui-scroll-wrapper" :class="detail.processState ? 'bottom-45' : ''">
        <div class="mui-scroll">
          <div class="detail-content">
            ...
            <change-content :list="detail.info.changeContentItemList"></change-content>
  ...
  export default{
    ...
    methods: {
      ...
      getDetail () {
        ...
        let infoData = {url: APIS.processCenter.certStudentInfoChangeApply, method: 'GET', param: infoParam}
