            ...
            <div class="mui-navigate-right" style="position: relative">
              ...
              <div class="mui-media-body" style="padding-left: 82px;">
                <span style="display: flex;">
                  <span style="color:#3A444A;font-size:16px;" v-text="item.plateNumber"></span>
                  <span class="item-teachingTypeName" v-text="item.usePropertiesName"></span>
                  <span class="item-teachingCarName" v-text="item.carStyle"></span>
                </span>
                <div class='mui-ellipsis' style="font-size: 12px;margin-top: 8px;color: #7F7F7F;">
                  <div>
                    片区：<span v-text="item.areaName"></span>
                  </div>
                  <div>
                    使用人：<span v-text="item.userName"></span>
                  </div>
                </div>
              </div>
            </div>
